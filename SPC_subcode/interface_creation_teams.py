...
def sauvegarder_equipes(equipes, fichier="SPC_teams.txt"): # Sauvergarde du fichier des équipes
...
def charger_equipes(fichier="SPC_teams.txt"): # Chargement du fichier équipes du repertoire
