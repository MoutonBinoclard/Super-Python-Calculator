...
def placement_points(placement, kills, total_players): # Define how the placement awards points
    # placement, kills, total_players -> int
    ...
    if placement == 0 or placement == -1:
        ...
        if placement>=4 and placement<=5 : return 5
        if placement>=6 and placement<=10 : return 3
        if placement>=11 and placement<=20 : return 1
        if placement>=21 : return 0
